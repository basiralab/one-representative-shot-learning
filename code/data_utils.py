...
class MRDataset(InMemoryDataset):
    ...
    def data_read(self, h="rh", nbr_of_subs=1000, connectomes=1):
        ...
        data_path = "../data/RH/AbsoluteDifference"

        for i in range(1, nbr_of_subs):
            s = data_path + "/oasis.cortical." + h.lower() + ".ShapeConnectivityTensor_OAS2_"
            if i < 10:
                s += "0"
            s += "00" + str(i) + "_"
